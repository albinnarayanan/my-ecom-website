...
function ProductViewModal({ open, setOpen, product, isAvailable }) {
  ...
  const { id, productName, image, description, quantity, price, discount,
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
                ...
                <button type='button' onClick={() => setOpen(false)} className="px-4 py-2 text-sm font-semibold text-slate-700 hover:text-slate-800 hover:border-slate-800 border rounded-md">
                    Close
                </button>
