...
const InputField = ({label, id, type, errors, register, required, message, className, 
        ...
        return (
            <div className="flex flex-col gap-1 w-full">
                ...
                <input type={type} id={id} placeholder={placeholder}
                    className={`${className ? className : ""} px-2 py-2 border outline-none
                                    bg-transparent text-slate-800 rounded-md 
