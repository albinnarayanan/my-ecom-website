...
const ProductCard = ({ productId, productName, image, description, quantity, 
                        price, discount, specialPrice, about=false }) => {
    ...
    return (
        <div className="border rounded-lg shadow-xl overflow-hidden transition-shadow duration-300">
            <div onClick={() => {handleProductView({ id:productId, productName, image,
                 description, quantity, price, discount, specialPrice })}} 
            ...
            <div className="p-4">
                <h2 onClick={() => {handleProductView({ id:productId, productName, image,
                 description, quantity, price, discount, specialPrice })}} 
                ...
                <button disabled={!isAvailable || btnLoader} onClick={() => addToCartHandler({image,productName,description,specialPrice,price,productId,quantity})}
                ...
                + " text-white px-3 py-2 rounded-lg items-center transition-colors duration-300 w-36 flex justify-center"}
                    ><FaShoppingCart className="mr-2"/>{isAvailable ? "Add to cart" : "Out of stock"}</button>
