...
const AddProductForm = ({setOpen, product, update=false}) => {
    ...
    if(categoryLoader){
        return  <div className="py-4 px-8 items-center">
    ...
    <div className='py-5 relative h-full'>
        <form onSubmit={handleSubmit(saveProductHandler)} className='space-y-4'>
            ...
            <div className='flex flex-col gap-2 w-full'>
                ...
                <textarea maxLength={255} rows={5} type="text" id="description" placeholder="Add Product Description"
                    className={`px-4 py-2 border outline-none
                                    bg-transparent text-slate-800 rounded-md w-full 
