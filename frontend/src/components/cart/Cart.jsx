...
const Cart = () =>{
    ...
    newCart.totalPrice = cart?.reduce(
        (acc, cur) => acc + Number(cur?.specialPrice || 0) * Number(cur?.quantity || 0),0
);
   ...
   return (
     <div className="lg:px-14 sm:px-8 px-4 py-10 ">
        ...
        <div className="grid md:grid-cols-5 pb-2 font-semibold items-center grid-cols-4 gap-4">
        ...
        <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4">
            ...
            <div className="flex text-sm gap-1 flex-col">
                ...
                <Link className="w-full justify-end " to={"/checkout"}>
                    <button onClick={()=>{}} className="font-semibold w-[300px] py-2 px-4 rounded-sm  text-white flex items-center justify-center gap-2 bg-blue-600 hover:text-gray-300 transition duration-500">
