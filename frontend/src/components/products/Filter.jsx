    ...
    return(
        <div className="flex lg:flex-row flex-col-reverse lg:justify-between justify-center items-center gap-4">
            ...
            <div className="flex sm:flex-row flex-col gap-4 items-center">
                ...
                <Tooltip title="Sorted by price : Low to High" arrow>
                    <Button onClick={toggleSortOrder} variant="contained" color="primary" className="flex items-center gap-2 h-10">
                        Sort By {sortOrder === "asc" ? <FiArrowUp size={20}/> : <FiArrowDown size={20}/>}</Button>
                ...
                <button className="flex items-center gap-2 bg-rose-900 text-white px-3 py-2 rounded-md transition duration-300 ease-in shadow-md focus:outline-none">
                        ...
                        <span className="font-semibold" onClick={handleClearFilter}>Clear Filter</span>
                </button>
